...
install: src/main/graphpass.c
	gcc src/main/graphpass.c src/main/analyze.c src/main/filter.c src/main/gexf.c src/main/io.c src/main/quickrun.c src/main/reports.c src/main/rnd.c src/main/viz.c $(DEPS) -L$(IGRAPH_LIB) -ligraph -lm  -o graphpass
	- ./graphpass -qn
...
debug: ./src/main/graphpass.c
	gcc -g src/main/graphpass.c src/main/analyze.c src/main/filter.c src/main/gexf.c src/main/io.c src/main/quickrun.c src/main/reports.c src/main/rnd.c src/main/viz.c $(DEPS) -L$(IGRAPH_LIB) -ligraph -lm  -o graphpass
